...
?>
		...
		$strXML="";
                ...
                $chart_open = "<chart caption='' subcaption='' palettecolors='#F31B1B,#F39C12,#5298C6,#00a65a,#B969CB,#0000FF' bgcolor='#ffffff' showborder='0' use3dlighting='0' showshadow='0' enablesmartlabels='0' startingangle='0' showpercentvalues='1' showpercentintooltip='0' decimals='1' captionfontsize='14' subcaptionfontsize='14' subcaptionfontbold='1' tooltipcolor='#ffffff' tooltipborderthickness='0' tooltipbgcolor='#000000' tooltipbgalpha='80' tooltipborderradius='2' tooltippadding='5' showhovereffect='1' showlegend='1' legendbgcolor='#ffffff' legendborderalpha='0' legendshadow='0' legenditemfontsize='10' legenditemfontcolor='#666666' usedataplotcolorforlabels='1'>\n";
                $chart_close =  "</chart>\n";
              ...
              <div class="box box-primary">
                ...
                <div class="box-body chart-responsive">
                  <?php
                        $chart_open = "<chart caption='' subcaption='' xaxisname='' yaxisname='#CRs' numberprefix='' palettecolors='#0075c2' bgalpha='0' borderalpha='20' canvasborderalpha='0' useplotgradientcolor='0' plotborderalpha='10' placevaluesinside='1' rotatevalues='1' valuefontcolor='#ffffff' captionpadding='20' showaxislines='1' axislinealpha='25' divlinealpha='10'>\n";
                        $chart_close= "</chart>\n";
